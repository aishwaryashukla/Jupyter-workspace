...
data1 = yf.download(final_list,start="2019-01-01",end="2021-01-05")
...
for ticker in final_list:
    close_price_df[ticker+".MA10"].plot(label=ticker+'.MA10',title=ticker)
    close_price_df[ticker+".MA50"].plot(label=ticker+'.MA50',title=ticker)
    plt.show()
